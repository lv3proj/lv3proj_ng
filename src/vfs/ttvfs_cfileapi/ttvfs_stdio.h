...
//-------------------------------------------------
#if defined(VFS_ENABLE_C_API) && VFS_ENABLE_C_API-0 == 1
...
ttvfs::Root *ttvfs_newroot();
void ttvfs_deleteroot(ttvfs::Root *root);
...
//--------------------------------------------------
#elif defined(VFS_ENABLE_C_API) && VFS_ENABLE_C_API-0 == 0
